...
INSERT INTO `locations` (`id_location`, `parent_id`, `location_name`, `location_description`) VALUES 
  ...
  (75,70,'Oficina Regional, Profesional en Sistemas',NULL),
  (76,1,'Guanay KM6',NULL),
  (77,1,'Huarina I',NULL),
  (78,77,'Huarina I, Carril 1',NULL),
  (80,NULL,'ORCB','<p>Cochabamba</p>\r\n'),
  (81,80,'Colcapirhua',''),
  (82,81,'Colcapirhua, carril 1','');
