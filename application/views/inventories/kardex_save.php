	...
	<div id="body">		
		...
		?>
			<table>
				<tr>
					<td>			
   					<input id="kardex_code" value="<?php ?>" type="text" name="kardex_code" placeholder="Codigo"/>
					</td>
				</tr>
				<tr>
					<td>
						<input id="kardex_serial" value="" type="text" name="kardex_serial" placeholder="Serie"/>
					</td>
				</tr>
				<tr>
					<td>			
